...
static queue_t *queue_sort_merge(queue_t *q1, queue_t *q2, int (*func) (const void*, const void*))
{
...
static queue_t *queue_sort_real (queue_t *queue, int (*func) (const void *, const void *))
{
    queue_t *q1, *q2;
